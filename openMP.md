...
4. Join: Once all the threads have completed their work, they synchronize and join back together into a single thread of execution (the master thread) at the end of the parallel region.
